...
def walkThru():
    ...
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [0.2,  0.02, 0.0]))  

    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [0.37, 0.08, 0.0]))  
    ...
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [0.6, 0.02, 0.02]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [0.78, 0.08, 0.02]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [1.0, 0.03, -0.01]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [1.22, 0.05, -0.01]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [1.44, 0.03, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [1.68, -0.05, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [1.9, 0.03, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [2.12, -0.05, 0.0]))   
