...
def walkTest():
    ...
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [0.4, -0.02, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [0.6, 0.0, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [0.8, -0.02, 0.0]))
    ...
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [1.6, -0.02, 0.0]))
    ...
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [2.4, -0.03, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [2.6, -0.01, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [2.85, -0.25, 0.0]))
    
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [2.8, -0.01, 0.0]))
    ...
    try:
        ...
        if not rospy.has_param('/ihmc_ros/robot_name'):
            ...
            if rospy.has_param(right_foot_frame_parameter_name) and rospy.has_param(left_foot_frame_parameter_name):
                ...
                detachsub = rospy.Subscriber("/valkyrie/harness/detach", Bool, queue_size=1) 
                ...
                if footStepListPublisher.get_num_connections() == 0:
                    ...
                    while footStepListPublisher.get_num_connections() == 0:
                        rate.sleep()
                while detachsub.get_num_connections() == 0:
                   rate.sleep()
                   #rospy.loginfo('waiting for detacj...')
...
'''
    ...
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [0.2, 0.0, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [0.3, 0.0, 0.0]))     
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [0.4, 0.0, 0.0]))

    #msg.footstep_data_list.append(createFootStepOffset(LEFT, [0.2, 0.0, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [0.6, 0.0, 0.0]))
    ...
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [1.4, 0.0, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [1.6, 0.0, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [1.8, 0.0, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [2.02, 0.0, 0.0]))
