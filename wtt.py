...
def walkThru():
    ...
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [0.37, 0.1, 0.0]))  
    ...
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [0.78, 0.2, 0.02]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [1.0, 0.03, -0.01]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [1.22, 0.01, -0.01]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [1.44, 0.03, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [1.68, 0.1, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [1.9, 0.03, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [2.12, 0.2, 0.0]))   
